...
public class RecyclerTasksCompletedAdapter extends RecyclerView.Adapter<RecyclerTasksCompletedAdapter.ViewHolder> {
    ArrayList<TaskModel> arrCompleted;
    RecyclerTasksCompletedAdapter(ArrayList<TaskModel> arrCompleted){
